...
function Email_Notif() {
    return (
        <>
            ...
            <section className="signup--instruction">
                <h1>We Sent You <br /> An Email</h1>
                <p className='email-p'>please varify your <br /> email before <br /> signing in</p>
            </section>

            <section className="signup--information">
                <button>continue</button>
            </section>

            <section className="signup--switch">
                <p>Have an account Let's</p>
                <a href="">Sign in</a>
            </section>
